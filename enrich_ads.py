...
def get_ads_data():
    """ Gets ads data """
    years = ["2020"]#["2006","2007", "2008", "2009","2010","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021"]
    ads = []
    for year in years:
                ...
                try:
                    ...
                    if(enrich_skills):
                        for skill in ad["enriched_candidates"]["competencies"]:
                            ...
                            if skill["prediction"] >= 0.8:
                                if skill_name not in skills:
                                    skills[skill_name] = { "series": pd.Series([0] * num, index=skillsIndex), "employers": {} }
                                ...
                                if adObj:
                                    ...
                                    if "adIds" not in skills[skill_name]:
                                        skills[skill_name]["adIds"] = [adId]
                                    else:
                                        skills[skill_name]["adIds"].append(adId)
                                    adId += 1

                                    if "count" in skills[skill_name]:
                                        skills[skill_name]["count"] += 1
                                    else:
                                        skills[skill_name]["count"] = 1

                                    for s in skills_found:
                                        if "skills" not in skills[skill_name]:
                                    ...
                                    for trait in ad["enriched_candidates"]["traits"]:
                                        ...
                                        if "traits" not in skills[skill_name]:
                                            skills[skill_name]["traits"] = {}
                                    ...
                                    for geo in ad["enriched_candidates"]["geos"]:
                                        ...
                                        if "geos" not in skills[skill_name]:
                                            skills[skill_name]["geos"] = {}
